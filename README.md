# Hệ Thống Quản Lý Sản Xuất (Manufacturing Management System)

Dự án phát triển hệ thống phần mềm quản lý sản xuất, vật tư, nhân sự dành cho nhà máy.
...
## Cấu trúc thư mục
Vui lòng tham khảo thư mục `docs/` để biết thêm chi tiết về kiến trúc, cơ sở dữ liệu và ngữ cảnh dự án.
